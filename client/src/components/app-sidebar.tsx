...
const sections = [
  ...
  { id: "divine-services", title: "Special Divine Services", icon: Pill, completed: false },
  ...
  { id: "womens-ministry", title: "Women's Ministries", icon: Heart, completed: false },
  { id: "offerings", title: "Offerings & Finance", icon: DollarSign, completed: true },
  { id: "facilities", title: "Facilities & Logistics", icon: Building, completed: false },
  { id: "challenges", title: "Challenges & Recommendations", icon: AlertTriangle, completed: false },
  { id: "acknowledgments", title: "Acknowledgments", icon: Heart, completed: false },
